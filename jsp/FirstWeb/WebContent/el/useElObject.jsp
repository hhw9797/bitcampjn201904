...
<body>
	<h3>
		...
		member 객체참조 1 - id : ${requestScope.member.id} <br>
		member 객체참조 2 - name : ${requestScope.member.name} <br>
		member 객체참조 3 - pNum : ${requestScope.member.pNum} <br>
		member 객체참조 4 - num : ${member.num} <br>
