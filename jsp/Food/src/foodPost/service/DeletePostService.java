...
import foodPost.exception.MessageNotFoundException;
...
public class DeletePostService {
	...
	public int deletePost(int bf_num, String u_pw) throws MessageNotFoundException, SQLException {
		...
		try {
			...
			resultCnt = dao.deleteMessage(conn, bf_num);
