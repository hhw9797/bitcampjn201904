...
public class DBCPInt extends HttpServlet {
	...
	private void loadJdbcDriver() {
		try {
			...
			System.out.println("Oracle 데이터벵스 드라이버 로드 성공..!!");
	...
	private void initConnectionPool() {
		try {
			...
			PoolingDriver driver = (PoolingDriver) DriverManager.getDriver("jdbc:apache:commons:dbcp:pool");
