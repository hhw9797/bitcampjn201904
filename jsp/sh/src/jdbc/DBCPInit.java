...
public class DBCPInit extends HttpServlet {
   ...
   private void initConnectionPool() {
      try {
          ...
          * String username = "bit"; String pw ="bit";
          */

         /*
          * String jdbcDriver = "jdbc:oracle:thin:@localhost:1521:orcl"; String username
         ...
         DriverManagerConnectionFactory connFactory = new DriverManagerConnectionFactory(jdbcDriver, username, pw);
