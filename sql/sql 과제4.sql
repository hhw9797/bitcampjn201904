...
select d.deptno as "부서번호", d.dname as "부서이름"
from emp e, dept d
where e.deptno=d.deptno and ename='SCOTT'
;

--33. INNER JOIN과 ON 연산자를 사용하여 사원 이름과 함께 그 사원이 소속된 부서이름과 지역 명을 출력하시오.
select e.ename as "사원이름", d.dname as "부서이름", d.loc as "지역 명"
...
select e.ename as "사원이름", e.job as "업무", e.deptno as "부서번호", d.dname as "부서명"
from emp e join dept d
on e.deptno=d.deptno and d.loc='NEW YORK'
;

--38. SELF JOIN을 사용하여 사원의 이름 및 사원번호, 관리자 이름을 출력하시오.
select ename.ename as "사원이름", ename.empno as "사원번호", mname.ename as "관리자 이름"
